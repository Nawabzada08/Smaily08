...
def logo():  
print("\033[1;35m─    _   __  __ ___ _____   _  _____   __  __   _     _  __   _     ___ _  _  ___  ___ ___   _   
print("\033[1;35m─   /_\ |  \/  |_ _|_   _| | |/ /_ _| |  \/  | /_\   | |/ /  /_\   | _ ) || |/ _ \/ __|   \ /_\  
print("\033[1;35m─  / _ \| |\/| || |  | |   | ' < | |  | |\/| |/ _ \  | ' <  / _ \  | _ \ __ | (_) \__ \ |) / _ \ 
print("\033[1;35m─/_/ \_\_|  |_|___| |_|   |_|\_\___| |_|  |_/_/ \_\ |_|\_\/_/ \_\ |___/_||_|\___/|___/___/_/ \_\
print("\033[1;35m──────────────────────────────────────────────────────────────────") 
print("\n                     \033[38;2;124;252;0mCreated By: UNB34T9BL3 BOII SM4ILY INSID3")
print("-----------------------------------------------------------------------")
...
def main():
    ...
    logo()
    print('-------------------------------------------')
    print("\033[1;34m Note >>  AMIT KII BH9N KA YAR SM4ILY 0N FIR3")
    print('-------------------------------------------')
    coki = input(' [+] Cookies : ')
    cookies={'cookie': coki}
    ...
    if 'mbasic_logout_button' in ch.text:
        ...
        print(' \x1b[1;91mYeh Tu awara ki maa ka boxda dal diya sai cookies dal 😹 !!! \x1b[1;97m')
        os.sys.exit()
    print(' \x1b[1;92m Account Logged in Successfully\x1b[1;97m ')
    print('-------------------------------------------')
    delay = int(input(' [+] AMIT KI BH3N CHODNA CH4LU : '))
    print('-------------------------------------------')
    lnk = input(' [+] AMIT KI BH39 KI CHUT MAI LINK DAL / Link id : ')
    print('-------------------------------------------')
    lim = int(input(' [+] AM1T KI R49D1 BH3N Repeat : '))
    print('-------------------------------------------')
    hater = input(' [+] AMIT KI RANDI BHEN J4B T4K N4 CHOD JY3  : ')
    print('-------------------------------------------')
    filee = input(' [+] File : ')
